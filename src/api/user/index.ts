 ...
 * @returns 登录结果
 */
export const reqLogin = (data: LoginParams) => request.post<LoginResponseData, any>(API.LOGIN_URL, data)
...
// 登出接口
export const reqLogout = () => request.post<LogoutResponseData, any>(API.LOGOUT_URL)
...
// 获取公告列表接口
export const reqNoticeList = () => request.get<NoticeListResponse, any>(API.GET_NOTICE_LIST)
...
// 2. 【增】新增昵称
export const reqAddNickname = (newName: string) => request.post<ResponseData, any>(API.NICKNAME_ADD, { newName })
...
// 书籍模块
// 获取书籍列表接口
export const reqGetBookList = () => request.get<BookResponse, any>(API.BOOK_LIST)

// 音乐模块
// 获取音乐列表接口
export const reqGetMusicList = () => request.get<MusicResponse, any>(API.MUSIC_LIST)

<template>
  <div class="siteHeaderLogo" :class="{ 'siteHeaderLogo-change': settingStore.isCollapse }">
    <div class="logo-wrapper">
      <div class="logo-inner">
        <img :src="settings.logo" class="logo" />
      </div>
    </div>
    <span class="title" :class="{ 'title-change': settingStore.isCollapse }">{{ settings.title }}</span>
  </div>
</template>
